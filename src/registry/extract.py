...
def _screenshot_model_to_registry_dict(provider: str, m: ModelInfo) -> Dict[str, Any]:
    return {
        ...
        "dollars_per_million_tokens_cached_input": m.dollars_per_million_tokens_cached_input,
        "dollars_per_million_tokens_cache_write_5m": m.dollars_per_million_tokens_cache_write_5m,
        "dollars_per_million_tokens_cache_write_1h": m.dollars_per_million_tokens_cache_write_1h,
        "dollars_per_million_tokens_cache_read": m.dollars_per_million_tokens_cache_read,
        "dollars_per_million_tokens_input_long_context": m.dollars_per_million_tokens_input_long_context,
        "dollars_per_million_tokens_output_long_context": m.dollars_per_million_tokens_output_long_context,
        "dollars_per_million_tokens_output_thinking": m.dollars_per_million_tokens_output_thinking,
        "cache_storage_cost_per_million_tokens_per_hour": m.cache_storage_cost_per_million_tokens_per_hour,
        ...
        "supports_long_context_pricing": m.supports_long_context_pricing,
